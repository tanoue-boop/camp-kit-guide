...
- 着手可能（`着手可否=○`）かつ仮説が `要判断` 以外の記事は **car-camp-lighting／bluetti-power／torch-burner** の3本（3サイクル目で portable-fridge／camp-gear-sale-timing、4サイクル目で camp-table-set、4サイクル目積み残し（campkit-20260921-04）で camp-table-folding を消化）。次サイクルはこの中から選ぶ

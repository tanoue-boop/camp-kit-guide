...
- **最終更新: 2026-07-24（寝袋カニバ整理：温度・季節・3シーズンの3記事を `sleeping-bag-temperature-guide`「寝袋（シュラフ）の選び方 完全ガイド」へ統合。統合元3本を削除し `next.config.ts` で恒久リダイレクト〔308〕。記事数140→137、sleeping-bag 19→16）**
...
- **総記事数: 137記事**（`ls content/posts/*.mdx | wc -l` で確認）

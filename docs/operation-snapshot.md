...
- **最終更新: 2026-08-10（日次タスク＝商品1本のみ追加。★バックログ枯渇日:pending総数3件のうち商品KWは cassette-gas-heater 1件のみ、ASP2件は使用不可〔camp-furusato=既存furusato-camp-guide情報型ピラー＋カテゴリ別furusato群と角度重複でカニバリ、asoview-experience=A8審査中でリンク未発行〕→品質優先の安全弁で商品1本を納品。cassette-gas-heater＝カセットガスストーブおすすめ5選・bonfire〔楽天API実データ:イワタニ デカ暖3 CB-STV-DKD3¥21,700/141件・風暖CB-GFH-5¥29,980/34件・デカ暖2 CB-STV-DKD2¥21,800/25件・イザまるCB-IZ-1¥14,850/17件・マイ暖III CB-STV-MYD3¥13,800/3件。イワタニ寡占商材につきブランド占有緩和で同ブランド5モデル・輻射式/温風式/2WAY/携帯で選び分け軸・実勢13,800〜29,980円で価格比2.17x・全CB缶暖房で用途一貫・source=rakuten。既存iwatani-stove(バーナー/調理・cookware)およびcamp-oil-stove(灯油/対流式大火力・bonfire)とはCB缶手軽暖房の角度で非カニバリ・CO対策/就寝時消火/低温時火力低下の安全FAQ反映〕。products.tsvに5行・amazon-worksheetに5行追記〔全5型Amazon.co.jp存在確認済・楽天源のため今回MDXにamazonUrl非設定=amzn.to発行バッチ待ち〕。★要対応:商品KW在庫補充が必要（source≠asp pending=0に）＋ASP在庫補充が必要（承認済み・非カニバリのASP角度が枯渇）。記事数173→174、bonfire 22→23。デプロイは `deploy.cjs` で反映）**
